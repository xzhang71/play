 ...
 */
public class ArrayStackDynamic2 {
    ...
    public ArrayStackDynamic2(int defaultCapacity, int numOfStacks) {
    ...
    private void shift(int stackNum) {
        ...
        for (int i = stack.pointer; stack.isWithinStack(i, totalCapacity) && i != previousIndex(stack.start); i = previousIndex(i)) {
            stackBuffer[nextIndex(i)] = stackBuffer[i];
        }
    ...
    public static void main(String[] args) {
        int defaultSize = 2;
        int numOfStacks = 2;
        ArrayStackDynamic2 arrayStackDynamic = new ArrayStackDynamic2(defaultSize, numOfStacks);
